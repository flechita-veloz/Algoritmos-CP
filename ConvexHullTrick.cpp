...
#define ll long long
using namespace std;
// Calcula el maximo o minimo "y" para un x dado a raiz 
...
int main() {
    // Ejemplo de uso
    ConvexHullDynamic chd(true); // true para máximos, false para mínimos
    chd.addLine(1, 2);
    chd.addLine(2, 3);
    chd.addLine(3, 4);
    cout << chd.getBest(5) << endl; // Obtener el mejor valor para x=5
    return 0;
}
